    ...
    <div class="container">
        <div class="top-bar d-flex justify-content-between align-items-center btnTopBar">
            ...
            <div>
                ...
                <a href="/profesionales/registro" class="btn btn-outline-secondary btn-sm">Soy médico o profesional de salud</a>
            </div>
        </div>
        ...
        <nav class="custom-navbar d-flex align-items-center">
            ...
            <div class="ms-auto d-flex align-items-center">
                <a href="/proveedores" class="nav-link text-dark p-0">Inicio</a>
                <a href="/proveedores/beneficios" class="nav-link text-dark p-0">Beneficios de unirme</a>
                <a href="/proveedores/funcionalidades" class="nav-link text-dark p-0">Funcionalidades</a>
                <a href="/proveedores/planes" class="nav-link text-dark p-0">Planes y precios</a>
                <a href="/proveedores/contacto" class="nav-link text-dark p-0">Contacto</a>
                <a href="#" class="nav-link text-dark p-0">Ayuda</a>
                <a href="/proveedores/login" class="nav-link text-dark p-0">Iniciar sesión</a>
                <a href="/proveedores/registro" class="btn btn-dark btn-unirme">Unirme</a>
            </div>
        </nav>
