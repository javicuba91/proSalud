                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('titulo') is-invalid @enderror" id="titulo"
                                name="titulo" value="{{ old('titulo', $articulo->titulo) }}" required>
                            @error('titulo')
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('resumen') is-invalid @enderror" id="resumen" name="resumen" rows="3"
                                maxlength="500" required>{{ old('resumen', $articulo->resumen) }}</textarea>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('seo_title') is-invalid @enderror"
                                ...
                                value="{{ old('seo_title', $articulo->seo['title'] ?? '') }}" maxlength="60">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('seo_description') is-invalid @enderror" id="seo_description"
                                name="seo_description" rows="2" maxlength="160">{{ old('seo_description', $articulo->seo['description'] ?? '') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('seo_keywords') is-invalid @enderror"
                                ...
                                value="{{ old('seo_keywords', $articulo->seo['keywords'] ?? '') }}"
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select name="estado" id="estado" class="form-control @error('estado') is-invalid @enderror"
                                ...
                                <option value="borrador"
                                    {{ old('estado', $articulo->estado) == 'borrador' ? 'selected' : '' }}>Borrador
                                </option>
                                <option value="publicado"
                                    {{ old('estado', $articulo->estado) == 'publicado' ? 'selected' : '' }}>Publicado
                                </option>
                                <option value="archivado"
                                    {{ old('estado', $articulo->estado) == 'archivado' ? 'selected' : '' }}>Archivado
                                </option>
                            </select>
                            @error('estado')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local"
                                class="form-control @error('fecha_publicacion') is-invalid @enderror" id="fecha_publicacion"
                                name="fecha_publicacion"
                                value="{{ old('fecha_publicacion', $articulo->fecha_publicacion ? $articulo->fecha_publicacion->format('Y-m-d\TH:i') : '') }}">
                            <small class="form-text text-muted">Si se deja vacío y el estado es "Publicado", se usará la
                                fecha actual</small>
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="destacado" name="destacado"
                                    value="1" {{ old('destacado', $articulo->destacado) ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="permite_comentarios"
                                    name="permite_comentarios" value="1"
                    ...
                    <div class="card-header">
                        <h3 class="card-title">
                            ...
                            <button type="button" class="btn btn-sm btn-outline-primary float-right" data-toggle="modal"
                                data-target="#modalNuevaEtiqueta">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        @if ($articulo->imagen_destacada)
                            <div class="mb-3">
                                <img src="{{ asset($articulo->imagen_destacada) }}" alt="{{ $articulo->titulo }}"
                        ...
                        <div class="form-group">
                            <input type="file"
                                class="form-control-file @error('imagen_destacada') is-invalid @enderror"
