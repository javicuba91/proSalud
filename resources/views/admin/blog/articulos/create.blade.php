...
@section('title', 'Crear Artículo del Blog')
...
@section('content')
    <form action="{{ route('blog.articulos.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('resumen') is-invalid @enderror" id="resumen" name="resumen" rows="3"
                                maxlength="500" required>{{ old('resumen') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('contenido') is-invalid @enderror" id="contenido" name="contenido" rows="10"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('seo_description') is-invalid @enderror" id="seo_description"
                                name="seo_description" rows="2" maxlength="160">{{ old('seo_description') }}</textarea>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select name="estado" id="estado" class="form-control @error('estado') is-invalid @enderror"
                                ...
                                <option value="archivado" {{ old('estado') == 'archivado' ? 'selected' : '' }}>Archivado
                                </option>
                            </select>
                            @error('estado')
                                <div class="invalid-feedback">{{ $message }}</div>
...
@section('js')
    ...
    <script>
        ...
        function updateCharCount(elementId, maxChars) {
            ...
            const counterElement = document.getElementById(elementId + '_counter');
            if (counterElement) {
