                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('resumen') is-invalid @enderror"
                                      id="resumen" name="resumen" rows="3" maxlength="500" required>{{ old('resumen') }}</textarea>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('seo_description') is-invalid @enderror"
                                      id="seo_description" name="seo_description" rows="2" maxlength="160">{{ old('seo_description') }}</textarea>
