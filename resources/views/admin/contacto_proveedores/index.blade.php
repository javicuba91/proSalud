...
@section('content')
    ...
    <!-- Panel de Filtros -->
    <div class="card mb-4 {{ request()->hasAny(['proveedor_id', 'estado']) ? 'filtros-activos' : '' }}">
        <div class="card-header">
            <h3 class="card-title">
                <i class="fas fa-filter"></i> Filtros
                @if(request()->hasAny(['proveedor_id', 'estado']))
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('admin.contacto_proveedores') }}" id="filtros-form">
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <a href="{{ route('admin.contacto_proveedores') }}" class="btn btn-secondary">
                ...
                <tbody>
                    @foreach ($contactos as $contacto)
                        <tr>
                            ...
                            @endif
                            <td>
                                <button class="btn btn-info btn-ver-detalle"
                                        data-id="{{ $contacto->id }}"
                                        data-proveedor="{{ $contacto->proveedor->nombre }}"
                                ...
                                @if ($contacto->estado === 'respondido')
                                    <button class="btn btn-warning btn-editar-respuesta"
                                            data-id="{{ $contacto->id }}"
                                            data-proveedor="{{ $contacto->proveedor->nombre }}"
                                            data-motivo="{{ $contacto->motivo }}"
                                            data-descripcion="{{ $contacto->descripcion }}"
                ...
                <div class="modal-body">
                    <form id="formResponder">
                        ...
                        <div class="form-group">
                            ...
                            <p id="proveedorNombre" class="font-weight-bold"></p>
                        </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label>Proveedor:</label>
                        <p id="detalleProveedorNombre" class="font-weight"></p>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formEditarRespuesta">
                        ...
                        <div class="form-group">
                            <label>Proveedor:</label>
                            <p id="editProveedorNombre" class="font-weight-bold"></p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div id="editContactoDescripcion" class="p-3 bg-light rounded"></div>
                        </div>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            if (totalContactos === 0) {
                $('#contactos_wrapper').after('<div class="alert alert-info mt-3"><i class="fas fa-info-circle"></i> No se encontraron mensajes con los filtros aplicados.</div>');
            } else {
                $('#contactos_wrapper').after('<div class="alert alert-success mt-3"><i class="fas fa-check-circle"></i> Se encontraron ' + totalContactos + ' mensaje(s).</div>');
            }
            ...
            $('.btn-responder').click(function() {
                ...
                $('#contactoId').val(id);
                $('#proveedorNombre').text(proveedor);
            ...
            $('.btn-editar-respuesta').click(function() {
                ...
                $('#editProveedorNombre').text(proveedor);
            ...
            $('.btn-ver-detalle').click(function() {
                ...
                $('#detalleProveedorNombre').text(proveedor);
            ...
            $('#btnEnviarRespuesta').click(function() {
                ...
                $.ajax({
                    url: `/admin/contacto-proveedores/${id}/responder`,
                    type: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}',
                        respuesta: respuesta
