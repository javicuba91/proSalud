...
@section('content')
    ...
    <!-- Panel de Filtros -->
    <div class="card mb-4 {{ request()->hasAny(['categoria_id', 'especialidad_id', 'sub_especialidad_id', 'profesional_id']) ? 'filtros-activos' : '' }}">
        <div class="card-header">
            <h3 class="card-title">
                <i class="fas fa-filter"></i> Filtros
                @if(request()->hasAny(['categoria_id', 'especialidad_id', 'sub_especialidad_id', 'profesional_id']))
                ...
                <tr>
                    <td>
                        ...
                        @if($respuesta->pregunta->categoria)
                            <span class="badge badge-primary">{{ $respuesta->pregunta->categoria->nombre }}</span>
                        @endif
                        @if($respuesta->pregunta->especialidad)
                            <span class="badge badge-success">{{ $respuesta->pregunta->especialidad->nombre }}</span>
                        @endif
                        @if($respuesta->pregunta->subespecialidad)
                            <span class="badge badge-info">{{ $respuesta->pregunta->subespecialidad->nombre }}</span>
                        @endif
                    </td>
