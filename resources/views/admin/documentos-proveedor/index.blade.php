...
@section('title', 'Documentos Proveedor')
...
@section('content_header')
    <h1>Documentos de Proveedores</h1>
...
@section('content')
    ...
    <div class="card mb-4 {{ request()->hasAny(['proveedor_id', 'estado']) ? 'filtros-activos' : '' }}">
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('documentos-proveedor.index') }}" id="filtros-form">
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <a href="{{ route('documentos-proveedor.index') }}" class="btn btn-secondary">
        ...
        <tbody>
            @foreach ($documentos as $documento)
                <tr>
                    ...
                    <td>
                        <form class="form-eliminar" action="{{ route('documentos-proveedor.destroy', $documento->id) }}"
    ...
    <script>
        $('.btn-aprobar').click(function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: `/admin/documentos-proveedor/${id}/aprobar`,
                        type: 'POST',
                        data: {
                            _token: '{{ csrf_token() }}'
                        },
        ...
        $(document).on('click', '.btn-denegar', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: `/admin/documentos-proveedor/${id}/denegar`,
                        type: 'POST',
                        data: {
                            _token: '{{ csrf_token() }}'
                        },
