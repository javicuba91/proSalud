...
@section('content_header')
    <h1>Facturación - Suscripciones de Planes Proveedores</h1>
@endsection
...
@section('content')
    ...
    <!-- Panel de Filtros -->
    <div class="card mb-4 {{ request()->hasAny(['proveedor_id', 'plan_id', 'fecha_inicio', 'fecha_fin', 'estado_pago']) ? 'filtros-activos' : '' }}">
        <div class="card-header">
            <h3 class="card-title">
                <i class="fas fa-filter"></i> Filtros
                @if(request()->hasAny(['proveedor_id', 'plan_id', 'fecha_inicio', 'fecha_fin', 'estado_pago']))
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('admin.facturacion.proveedor.index') }}" id="filtros-form">
                <div class="row">
                    <div class="col-md">
                  ...
                  <div class="row">
                    <div class="col-12">
                        ...
                        <a href="{{ route('admin.facturacion.proveedor.index') }}" class="btn btn-secondary">
                ...
                <tbody>
                    @foreach($suscripciones as $suscripcion)
                        <tr>
                            ...
                            <td>{{ $suscripcion->proveedor->nombre ?? 'N/A' }}</td>
                            ...
                            <td>
                                <a href="{{ route('admin.facturacion.proveedor.show', $suscripcion->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i></a>
                                @if(!$suscripcion->pagado)
                                    @php
                                    ...
                                    @endphp
                                    @if($enRangoFechas)
                                        <a href="{{ route('admin.facturacion.proveedor.pagar', $suscripcion->id) }}" class="btn btn-success btn-sm">
