    ...
    <div id="listado-pacientes">
        @foreach ($pacientes as $index => $paciente)
            <div class="row mt-3 border p-2 paciente-item" data-id="{{ $paciente->id }}">
                <div class="col-lg-2">
                    <input type="text" class="form-control" value="P-{{ str_pad($index + 1, 4, '0', STR_PAD_LEFT) }}" placeholder="P-0017">
                </div>
                <div class="col-lg-3">
                    <input type="email" class="form-control" value="{{ $paciente->email }}" placeholder="paciente1@prosalud.com" readonly>
                </div>
                <div class="col-lg-3">
            ...
            if (query.length >= 2) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#resultados-pacientes').html(`<ul class="list-group">${lista}</ul>`);
                    }
                });
            } else {
