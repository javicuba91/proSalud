        ...
        <div class="col-lg-12">
            ...
            @if(isset($pedidos) && $pedidos->isEmpty())
                <div class="alert alert-info">
                    <i class="fas fa-info-circle"></i> No hay pedidos de imágenes registrados.
                </div>
            ...
            @else
                <div class="alert alert-warning">
                    <i class="fas fa-exclamation-triangle"></i> No se pudieron cargar los pedidos de imágenes.
                </div>
            @endif
        </div>
    </div>
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalPedidoLabel">Detalles del Pedido de Imágenes</h5>
...
@section('js')
    ...
    <script>
        ...
        function verPedido(pedidoId) {
            ...
            const url = `{{ url('/profesional/pedidos-imagenes') }}/${pedidoId}/detalles`;
