...
@section('title', 'Mis Citas por Videollamada')
...
@section('content_header')
    <h1 class="titulocitas">Realizar videoconsulta</h1>
@stop
...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <a href="/profesional/mis-citas/agendar" class="btn btn-dark w-100 ">Programar nueva videoconsulta</a>
        </div>
    </div>
    <div class="row mt-2">
        <div class="col-lg-6">
    ...
    <div class="row mt-2">
        ...
        <div class="col-lg-12 hidden">
            <div class="listadoCitasVideollamada">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function cargarCalendario(filtro = 'todas') {
                ...
                fetch("{{ route('profesional.citasVideoLlamadasJson') }}?filtro=" + filtro)
            ...
            $('.modoCalendario').on('click', function() {
                ...
                $('.listadoCitasVideollamada').parent().addClass('hidden');
            ...
            $('.modoListado').on('click', function() {
                ...
                $('.listadoCitasVideollamada').parent().removeClass('hidden');
            ...
            function cargarListado(filtro) {
                $.ajax({
                    ...
                    url: '{{ route('profesional.listadoCitasVideollamada') }}',
                    method: 'GET',
                    data: {
                        filtro: filtro
                    },
                    success: function(html) {
                        $('.listadoCitasVideollamada').html(html);
                    },
                    error: function() {
                        $('.listadoCitasVideollamada').html(
