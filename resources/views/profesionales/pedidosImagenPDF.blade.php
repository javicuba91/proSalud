...
<body>
    ...
    <div class="clinical-info">
        ...
        <div class="clinical-detail">
            ...
            <div class="value">{{ $pedido->sintomas }}</div>
        </div>
        @endif
    ...
    @if($pedido->pruebas && $pedido->pruebas->count() > 0)
        @foreach($pedido->pruebas as $prueba)
            <div class="prueba-item">
                ...
                <div class="prueba-detail">
                    <span class="label">Region Anatomica:</span>
                    <span class="value">{{ $prueba->region_anatomica }}</span>
                </div>
    ...
    @else
        <div class="border">
            <p style="text-align: center; color: #666; margin: 0;">No se han agregado pruebas de Imagen</p>
        </div>
    @endif
