        ...
        <div class="col-12">
            ...
            <div class="card mb-3">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><i class="fas fa-flask"></i> Información del Pedido</h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <p><strong>Síntomas:</strong> {{ $pedido->sintoma ?? 'N/A' }}</p>
            ...
            <div class="card">
                <div class="card-header bg-success text-white">
                    <h5 class="mb-0"><i class="fas fa-vial"></i> Pruebas Solicitadas
                        ({{ $pedido->pruebas ? $pedido->pruebas->count() : 0 }})</h5>
                </div>
                <div class="card-body">
                    @if (!$pedido->pruebas || $pedido->pruebas->isEmpty())
                        <div class="alert alert-warning">
                            <i class="fas fa-exclamation-triangle"></i> No hay pruebas asociadas a este pedido.
                        </div>
                    @else
