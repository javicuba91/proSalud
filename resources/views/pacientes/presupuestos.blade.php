                ...
                @foreach($pruebas as $prueba)
                    @foreach($prueba->presupuestos as $presupuesto)
                        <tr>
                            ...
                            <td>
                                @if($presupuesto->estado == 'pendiente')
                                    <form method="POST" action="{{ route('paciente.presupuestos.aceptar', $presupuesto->id) }}" class="form-aceptar-presupuesto">
                                        @csrf
                                        <button type="button" class="btn btn-success btn-sm btn-aceptar-presupuesto">Aceptar</button>
                                    </form>
                                @else
                                    -
                                @endif
